...
#define SELL_ACTION_CONDITION "{_obj = missionNamespace getVariable ['R3F_LOG_player_target_object', objNull]; _obj isKindOf 'ReammoBox_F' || {_obj isKindOf 'AllVehicles'}}"
