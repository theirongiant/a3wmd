...
//MD- Why would we be here is it's dedicated?
if (isDedicated) exitWith {};

//MD- isServer = true if playing a single player mission
//MD- but, as above, why make this check, when would it be true?
//MD- and under what circumstances?
if (!isServer) then
{
	//MD- wait for a library to load?
